...
# sbatch wrf_to_xanthos_process_ssp5_hot_near.sh 
# squeue -u USERNAME
#
# ------------------------------------------------------
...
date
R CMD BATCH /global/cfs/cdirs/m2702/gcamusa/wrf_to_xanthos/wrf_to_xanthos_process_ssp5_hot_near.R 
date
...
date
python /global/cfs/cdirs/m2702/gcamusa/wrf_to_xanthos/wrf_to_xanthos_process_ssp5_hot_near.py
date
echo 'completed wrf_to_xanthos_process_ssp5_hot_near.py'
