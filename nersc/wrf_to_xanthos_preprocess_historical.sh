...
path="/global/cfs/cdirs/m2702/gsharing/CONUS_TGW_WRF_Historical/"
...
date
Rscript /global/cfs/cdirs/m2702/gcamusa/wrf_to_xanthos/wrf_to_xanthos_preprocess_historical.R ${RUN_FILES}  ${SLURM_ARRAY_TASK_ID}
date
echo 'completed wrf_to_xanthos_preprocess_historical.R'
